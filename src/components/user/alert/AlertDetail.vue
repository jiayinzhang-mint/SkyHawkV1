                ...
                <div v-if="alertInfo.state==1">
                    ...
                    <div v-if="alertInfo.auto==1">
                        <div v-if="userInfo.role==1">
                            <v-btn dark round depressed class="hidden-md-and-down" color="blue darken-2" v-if="alertInfo.uncertain == 0" @click="uncertainAlert">不确定</v-btn>
                            <v-btn dark round depressed class="hidden-md-and-down" color="blue darken-1" v-if="alertInfo.uncertain == 0" @click="errorAlert">误报</v-btn>
                            <v-btn dark round depressed class="hidden-md-and-down" color="primary" v-if="alertInfo.uncertain == 0" @click="repostAlert">下发</v-btn>
                            ...
                            <v-menu offset-y class="hidden-lg-and-up">
                                ...
                                <v-list>
                                    <v-list-tile v-if="alertInfo.uncertain == 0" @click="uncertainAlert">
                                        <v-list-tile-title>不确定</v-list-tile-title>
                                    </v-list-tile>
                                    <v-list-tile v-if="alertInfo.uncertain == 0" @click="errorAlert">
                                        <v-list-tile-title>误报</v-list-tile-title>
                                    </v-list-tile>
                                    <v-list-tile v-if="alertInfo.uncertain == 0" @click="repostAlert">
