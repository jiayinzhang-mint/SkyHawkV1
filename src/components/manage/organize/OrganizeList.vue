    ...
    <v-layout row>
        <v-flex xs12 sm4>
            <v-toolbar flat color="white">
                ...
                <v-btn icon @click="newOrganizeDialog=true" v-if="selectedOrganize.level!=3 && selectedOrganize.level!=0">
                    <v-icon>add</v-icon>
                </v-btn>
            </v-toolbar>
            <v-divider></v-divider>
            ...
            <el-dialog center title="新建组织" :visible.sync="newOrganizeDialog" width="400px">
                <el-form label-position="left" ref="organizeForm" :model="newOrganizeForm" label-width="90px">
