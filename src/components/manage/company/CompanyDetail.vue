  ...
  <v-container style="height:calc(100vh - 64px);overflow :auto">
    <v-card v-loading="loading" element-loading-background="rgba(0, 0, 0, 0.3)">
      <v-tabs v-model="tab" centered>
        ...
        <v-tab key="3">监管人</v-tab>
        <v-tab key="4">监控点</v-tab>
      </v-tabs>
      <v-divider></v-divider>
      ...
      <v-tabs-items v-model="tab">
        <v-tab-item key="1">
          <v-toolbar flat color="transparent">
            ...
            <v-spacer></v-spacer>
            <v-btn depressed class="primary" round @click="editCompany">保存</v-btn>
          </v-toolbar>
          <v-container>
            <el-form
              label-position="left"
            ...
            >
              ...
              <el-form-item label="营业执照有效至">
                <el-date-picker
                  type="date"
                  placeholder="选择日期"
                  v-model="companyForm.license_validity"
                  style="width: 100%;"
                ></el-date-picker>
              </el-form-item>
            </el-form>
        ...
        <v-tab-item key="2">
          <v-toolbar flat color="transparent">
            ...
            <v-spacer></v-spacer>
            <v-btn depressed class="primary" round @click="newUserDialog=true">新建</v-btn>
          </v-toolbar>
        ...
        <v-tab-item key="3">
          <v-toolbar flat color="transparent">
            ...
            <v-spacer></v-spacer>
            <v-btn depressed class="primary" round @click="newSupervisorDialog=true">新建</v-btn>
          </v-toolbar>
        ...
        <v-tab-item key="4">
          <v-toolbar flat color="transparent">
            ...
            <v-spacer></v-spacer>
            <v-btn depressed class="primary" round @click="newMonitorDialog=true">新建</v-btn>
          </v-toolbar>
          <v-data-table
            :headers="headersMonitor"
            :items="monitorList"
            hide-actions
            no-data-text="暂无数据"
          >
            <template slot="items" slot-scope="props">
              ...
              <td class="text-xs-center">
                <v-btn
                  ...
                  icon
                  flat
                  @click="editMonitorDialog=true;monitorForm=props.item"
                >
                  <v-icon>edit</v-icon>
                </v-btn>
...
export default {
  data: () => ({
    ...
    monitorRules: {
      ...
      channel: [{ required: true, message: "请输入名称", trigger: "blur" }],
